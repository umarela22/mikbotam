...
?>
    ...
    function Passmikbot() {
        ...
        var x = document.getElementById('passwordsesion');
        if (x.type === 'password') {
            x.type = 'text';
        } else {
            x.type = 'password';
...
<div id="test-connect" ></div>
                            ...
                            <div class="col-xl-6 mg-t-15">
                                ...
                                <!-- card -->
                            </div>	<div class="col-xl-6 mg-t-15">
                <div class="card bd-primary">
                    <div class="card-header bg-primary tx-white">
                    ...
                    <div class="card-body pd-sm-15">
                            ...
                            <div class="row mg-t-8">
                                ...
                                <div class="col-lg">
                                                    ...
                                                    <span class="input-group-addon bg-transparent">
                  <label class="ckbox wd-16">
                    <input type="checkbox" name="checkbox" value="0" onclick="Passsession()" ><span></span>
                                                    </label>
                                                    </span>
                                                    <input  id="passwordsesion" type="password" class="form-control" name="pass" placeholder="Password" value="<?=seepasssession($id);?>">
                                                </div>
                                </div>
                            </div>
